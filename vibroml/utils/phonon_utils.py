...
def run_single_phonon_analysis(atoms, calculator, engine, units, supercell_n, delta, fmax, output_dir, prefix="phonon_run", phonon_path_npoints=100, phonon_dos_grid=(40,40,40), traj_kT=1.0, num_modes_to_return=2, ph_obj_for_specific_mode=None, q_point_for_specific_mode=None, band_idx_for_specific_mode=None):
   """
   ...
   plot_phonon_results(bs_energies, dos, dos_energies, all_k_point_distances, special_k_point_distances, special_k_point_labels, discontinuities, y_label, struct_formula, prefix, supercell_n, delta, fmax, output_dir)
   ...
   softest_modes_info_list = analyze_special_points_and_modes(
      ...
      target_q_point=q_point_for_specific_mode, target_band_idx=band_idx_for_specific_mode
   )
...
def analyze_special_points_and_modes(ph, path, bs_energies, special_k_point_distances, special_k_point_labels, units, output_dir, prefix, traj_kT=1, num_modes_to_return=2, target_q_point=None, target_band_idx=None):
